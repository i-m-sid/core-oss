...
import { List, MessageSquare, Check, Calendar, FileText, ArrowUp } from "lucide-react";
import {
  AI_CHAT_STEPS,
  AI_CHAT_ACTIONS,
...
const ACTION_ICONS: Record<AIChatActionKey, typeof List> = {
  "Summarise":    List,
...
function ActionIcon({ actionKey }: { actionKey: AIChatActionKey }) {
  const Icon = ACTION_ICONS[actionKey];
  return <Icon size={14} color="rgba(255,255,255,0.75)" strokeWidth={2} />;
}
    ...
    <div className="mt-3 space-y-1">
      {files.map((f) => {
        ...
        return (
          ...
          >
            <FileText size={9} color={isMatch && isDone ? "#22d3ee" : "rgba(255,255,255,0.18)"} strokeWidth={2} />
            ...
            >
              <div className="relative p-3 pb-10 min-h-[68px]">
                ...
                <div className="absolute right-3 bottom-3">
                  ...
                  >
                    <ArrowUp size={11} color={typedPrompt ? "#000" : "#505058"} strokeWidth={2.5} />
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <div className="relative min-h-[120px] p-4 pb-12">
                ...
                <div className="absolute right-3 bottom-3">
                  ...
                  >
                    <ArrowUp size={12} color={typedPrompt ? "#000" : "#505058"} strokeWidth={2.5} />
                  </div>
                </div>
              </div>
            </div>
