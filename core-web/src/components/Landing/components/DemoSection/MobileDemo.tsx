...
export default function MobileDemo({ renderView }: MobileDemoProps) {
  ...
  const tabs: Tab[] = [
    { id: "inbox",    label: "Inbox",    icon: <InboxIcon    active={activeView === "inbox"}    /> },
    { id: "email",    label: "Email",    icon: <EmailIcon    active={activeView === "email"}    /> },
    { id: "chat",     label: "AI Chat",  icon: <ChatIcon     active={activeView === "chat"}     /> },
    { id: "calendar", label: "Calendar", icon: <CalendarIcon active={activeView === "calendar"} /> },
  ];
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-[12px] font-semibold" style={{ color: T_PRI }}>{time}</span>
        <div className="flex items-center gap-1.5">
          ...
          {/* WiFi */}
          <svg width="14" height="10" viewBox="0 0 24 18" fill="none" stroke={T_DIM} strokeWidth="2.2" strokeLinecap="round">
          ...
          <svg width="22" height="11" viewBox="0 0 22 11" fill="none">
            <rect x="0.5" y="0.5" width="18" height="10" rx="2" stroke={T_DIM} strokeWidth="1"/>
