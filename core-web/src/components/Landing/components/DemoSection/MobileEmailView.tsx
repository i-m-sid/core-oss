          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-baseline justify-between gap-1">
                ...
                <span className="text-demo-xs shrink-0" style={{ color: T_DIM }}>
                  {e.time}
                </span>
              </div>
              <p
  ...
  return (
    <div className="flex flex-col h-full" style={{ background: "#121314" }}>
      ...
      >
        ...
        <span
          className="text-demo-md font-semibold truncate flex-1"
          style={{ color: T_PRI }}
        >
          {email.subject}
        </span>
      ...
      >
        <img
          ...
          style={{
            filter: "invert(60%) sepia(80%) saturate(400%) hue-rotate(210deg)",
          }}
        />
        <span
        ...
        <span className="text-[10.5px] leading-snug" style={{ color: T_SEC }}>
          {AI_SUMMARIES[email.id]}
        </span>
      </div>
          ...
          <div className="mt-4 space-y-3">
            {sentReplies.map((reply, i) => (
              <div key={i} className="flex items-start gap-2.5">
                <div className="w-7 h-7 rounded-full overflow-hidden shrink-0 bg-demo-surface flex items-center justify-center mt-0.5">
                  <img
                    src={ME_AVATAR}
                    alt="You"
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-1 mb-1">
                    <span
                      className="text-demo-sm font-semibold"
                      style={{ color: T_PRI }}
                    >
                      You
                    </span>
                    <span style={{ color: T_DIM }}>·</span>
                    <span className="text-[10.5px]" style={{ color: T_DIM }}>
                      just now
                    </span>
                  </div>
                  <div
                    className="px-3 py-2 rounded-xl text-demo-sm leading-relaxed"
                    style={{
      ...
      <div className="px-4 pb-4 shrink-0">
        ...
        {replyOpen ? (
          ...
          >
            <div className="px-3.5 pt-3 pb-2 min-h-15">
              <p
                className="text-demo-sm leading-relaxed"
                style={{ color: T_SEC }}
              >
            ...
            >
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="text-demo-xs px-2 py-0.5 rounded cursor-pointer"
                  style={{ color: T_DIM }}
                >
                  Discard
                </button>
...
export default function MobileEmailMock() {
