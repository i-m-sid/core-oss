  ...
  return (
    ...
    >
      ...
      <div className="px-1.5 pt-2 flex flex-col">
        <NavItem icon={<Sparkles size={16} strokeWidth={1.7} />}        label="Assistant" active={activeView === "chat"}     onClick={() => onViewChange("chat")} />
        <NavItem icon={<Inbox size={16} strokeWidth={1.7} />}           label="Messages"  count={3} active={activeView === "inbox"}    onClick={() => onViewChange("inbox")} />
        <NavItem icon={<Mail size={16} strokeWidth={1.7} />}            label="Email"     active={activeView === "email"}    onClick={() => onViewChange("email")} />
        <NavItem icon={<LayoutDashboard size={16} strokeWidth={1.7} />} label="Projects"  active={activeView === "kanban"}   onClick={() => onViewChange("kanban")} />
        <NavItem icon={<Calendar size={16} strokeWidth={1.7} />}        label="Calendar"  active={activeView === "calendar"} onClick={() => onViewChange("calendar")} />
        <NavItem icon={<File size={16} strokeWidth={1.7} />}            label="Files"     active={activeView === "docs"}     onClick={() => onViewChange("docs")} />
      </div>
            ...
            <div key={folder}>
              ...
              >
                {isOpen
                  ...
                  : <ChevronRight size={10} color={TEXT_DIM} strokeWidth={2.5} />
                }
