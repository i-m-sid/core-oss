...
export default function InboxMock() {
  ...
  return (
    <div className="flex h-full w-full overflow-hidden">
      {/* Left pane */}
      <div
        className="w-72.5 shrink-0 flex flex-col overflow-hidden"
      ...
      >
        ...
        >
          <span className="text-[15px] font-semibold" style={{ color: T_PRI }}>
            Cube
          </span>
        </div>
        ...
        <div className="flex-1 overflow-y-auto py-2">
          <div className="px-5 pt-2 pb-2">
            <span
              className="text-demo-xs font-semibold uppercase tracking-wider"
              style={{ color: T_DIM }}
            >
              Channels
            </span>
          ...
          {CHANNELS.map((ch) => (
            <button
              ...
              style={{
                ...
                color:
                  activeChannel === ch.id ? T_PRI : ch.unread ? T_SEC : T_DIM,
            ...
            >
              <span className="text-[15px] shrink-0" style={{ color: T_DIM }}>
                #
              </span>
          ...
          {DMS.map((dm) => (
            ...
            >
              <div className="relative shrink-0">
                <div className="w-6 h-6 rounded-full overflow-hidden bg-demo-surface">
                  <img
                    src={AVATARS[dm.sender]}
                    alt={dm.label}
      ...
      >
        ...
        >
          {isDM ? (
            <>
              <div className="w-5 h-5 rounded-full overflow-hidden bg-demo-surface shrink-0">
                <img
                  src={AVATARS[activeDM!.sender]}
                  alt={channelLabel}
                  className="w-full h-full object-cover"
                />
              </div>
              <span
                className="text-demo-lg font-semibold"
                style={{ color: T_PRI }}
              >
                {channelLabel}
              </span>
            ...
            <>
              <span className="text-[15px]" style={{ color: T_DIM }}>
                #
              </span>
              <span
                className="text-demo-lg font-semibold"
            ...
            return (
              ...
              >
                <div className="w-8 h-8 shrink-0">
                  {!prevSame && (
                    <div className="w-8 h-8 rounded-full overflow-hidden bg-demo-surface">
                      <img
